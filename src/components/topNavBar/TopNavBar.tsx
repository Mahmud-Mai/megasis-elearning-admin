...
export default function TopNavBar() {
    return (
        <Navbar fixed='top' expand={false} className="navbar navbar-light bg-light navbar-fix justify-content-between">
            <Container>
                <div className="rounded row justify-content-between align-items-center my-1 mx-2 px-2 py-1" style={{ width: "400px", backgroundColor: "#E8E8E8" }}>
                ...
                <div className='row justify-content-end m-2'>
                    <div className='col-3 d-flex justify-content-center align-items-center text-center' style={{ height: "40px", width: "40px", padding: "auto", borderRadius: "50%", backgroundColor: "lightgrey" }}>
                    ...
                    <div className="col-3 d-flex justify-content-center align-items-center text-center" >
                        <ImageAvater alt="" src="https://www.wikihow.com/images/9/90/What_type_of_person_are_you_quiz_pic.png" />
                    </div>
